 ...
 * @since 1.1.0
 */
class Thenobility_Donator_Section extends Widget_Base {
	...
	public function get_name() {
		return 'thenobility-donator-section';
	}
	...
	public function get_title() {
		return __( 'Thenobility Donator Section', 'thenobility-toolkit' );
	}
	...
	protected function _register_controls() {
		// Content Controls
  		$this->start_controls_section(
  			'thenobility_donator_section',
  			[
  				'label' => esc_html_x( 'Donator Section','Admin Panel','thenobility-toolkit' )
  			]
  		); 
        
                      
        $this->add_control(
          'donator_section_image',
          [
	...
	protected function render( ) {
        ...
        //Image Show
        $donator_section_image = $this->get_settings( 'donator_section_image' );
        
        //Website Link
        $donator_section_link = $this->get_settings( 'donator_section_link' );
        $url = $donator_section_link['url'];
        $target = $donator_section_link['is_external'] ? 'target="_blank"' : '';
        ?>      
            
           
            <div class="single-doner">
                <?php echo '<img src="' . $donator_section_image['url'] . '">'; ?>
                <div class="doner-hover-info">
                    <div class="volunteer-icons doner-icons">
                       <h4><?php echo $settings["donator_section_title"]; ?></h4>
                        <p><?php echo   $settings['donator_section_description']; ?></p>
                        <ul>
                            <?php
